...
int keluar(){
 ticho();
 cout<<"\t=+=+=+=+==+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+="<<endl;
 cout<<"\t=======Thank You For Using My Simple Calculator Program======="<<endl;
...
int main(){
    cout << "\t=+=+=+=+==+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+="<< endl;
    cout << "\t=+=+=+=+=+=+= Welcome My Project, My Calculator. =+=+=+=+=+=+="<< endl;
    cout << "\t=+=+=+=+==+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+="<< endl;
 ...
 cout<<"5. Pangkat 2 (^2)"<<endl;
 cout<<"6. Pangkat 3 (^3)"<<endl;
